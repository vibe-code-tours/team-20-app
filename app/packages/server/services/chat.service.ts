...
// Local dev: cwd = app/packages/server, prompts at cwd/prompts
// Netlify:   cwd = /var/task, prompts at /var/task/app/packages/server/prompts
const promptsDir = process.env.NETLIFY
